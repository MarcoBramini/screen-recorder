...
//
//int64_t get_relative_input_frame_pts(AVStream* inputStream, AVFrame* decodedFrame){
//
//    return decodedFrame->pts-inputStream->start_time;
//}
//
//int RecordingService::encode_audio_from_buffer(int64_t decodedFramePts, bool shouldFlush) {
//
//    AVPacket *output_packet = av_packet_alloc();
//    if (!output_packet) {
...
//
//            if (outputFrame != nullptr) {
//                outputFrame->pts = av_rescale_q(decodedFramePts, inputAudioAvs->time_base, outputAudioAvcc->time_base);
//            }
//
...
//
//            output_packet->pts =output_packet->dts= av_rescale_q(output_packet->pts, outputAudioAvcc->time_base, outputAudioAvs->time_base);
...
//            }
//
//            if (encode_audio_from_buffer(get_relative_input_frame_pts(inputAudioAvs, audioInputFrame), false) < 0) {
//                throw std::runtime_error("Error converting audio frame");
//            }
//        }
