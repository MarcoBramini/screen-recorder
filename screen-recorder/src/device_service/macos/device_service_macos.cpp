...
PermissionsStatus DeviceService::check_permissions() {
    ...
    return {.screenCaptureAllowed=screenCaptureAllowed, .microphoneCaptureAllowed=microphoneCaptureAllowed, .cameraCaptureAllowed=cameraCaptureAllowed };
}
...
void DeviceService::setup_microphone_usage_permission() {
    request_microphone_capture_permissions();
}

void DeviceService::setup_camera_usage_permission() {
    request_camera_capture_permissions();
}
